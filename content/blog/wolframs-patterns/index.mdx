...
The left side of this result looks pretty predictable. But the rest is not. It follows no predictable pattern at all. In fact, if you execute the pattern for 500 rows...
...
... you can see the right side looks very chaotic. It's entirely unpredictable. It is essentially random.
