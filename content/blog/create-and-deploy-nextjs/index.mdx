...
I don't intend to make any code changes at this time. I want to get live as soon as possible, and go from there.
...
I expected to have to install a command line tool, but instead, it's as simple as the following command:
...
Next, it asked me to select a template. I picked the default. I'm not picky here, Next.js.
